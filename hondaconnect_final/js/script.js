...
if(indicatorPositionFixed!=''){
	defaultPosition = indicatorPosition =indicatorPositionFixed;
}
console.log(activeElement);
console.log(activeElement.position().left+":"+activeElement.parent().position().left);
